...
[![x-cmd/install — yt-x Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/yt-x.svg?lang=zh)](https://x-cmd.com/install/yt-x)
...
- **上游仓库**: <https://github.com/Benexl/yt-x>
- **许可证**: MIT
...
- **Star**: 1,660 · **Fork**: 77 · **开放 issue**: 132 · **贡献者**: 27

## 累计统计

- **发布数**: 20 · **已合并 PR**: 45 · **开放 PR**: 0 · **已关闭 issue**: 121 · **开放 issue**: 11 · **提交数**: 584

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-24 | 0 | 1 | 0 | 0 | 2 | 2 |
| last60d | 2026-07-25 | 0 | 2 | 0 | 2 | 2 | 13 |
| 90d | 2026-06-25 | 0 | 4 | 0 | 4 | 3 | 25 |
| last180d | 2026-03-27 | 11 | 11 | 0 | 26 | 9 | 315 |
| 360d | 2025-09-28 | 11 | 18 | 0 | 47 | 11 | 332 |
| last720d | 2024-10-03 | 20 | 45 | 0 | 121 | 11 | 551 |
...
yt-x 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `yt-x` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/yt-x.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260923.yml` · 2026-09-23T05:49:05Z._
